...
namespace _29_PhamThiNgocMai_Assignment3.Controllers
{
    ...
    {
        private readonly _29_PhamThiNgocMai_Assignment3Context _context;
        private readonly IHubContext<SignalrServer> _signalRHub;
        private readonly IConfiguration Configuration;

        public PostsController(_29_PhamThiNgocMai_Assignment3Context context, IHubContext<SignalrServer> signalRHub,
        ...
        public async Task<IActionResult> DeleteConfirmed(int PostId)
        {
            ...
            {
                return Problem("Entity set '_29_PhamThiNgocMai_Assignment3Context.Post'  is null.");
            }
