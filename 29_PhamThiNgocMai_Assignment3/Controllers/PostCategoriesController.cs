...
namespace _29_PhamThiNgocMai_Assignment3.Controllers
{
    public class PostCategoriesController : Controller
    {
        ...
        public PostCategoriesController(_29_PhamThiNgocMai_Assignment3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.PostCategory != null ? 
                          ...
                          Problem("Entity set '_29_PhamThiNgocMai_Assignment3Context.PostCategory'  is null.");
        }
